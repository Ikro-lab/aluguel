...
export const STATUS_AGENDAMENTO = [
  { value: 'aguardando_confirmacao', label: 'Aguardando confirmação', color: 'amber' },
...
export const TEMPO_USO_OPCOES = ['30 minutos', '1 hora', '2 horas', '3 horas', '4 horas', 'Diária'];
...
export const ORIGEM_OS = [
  { value: 'frota', label: 'Bike da frota' },
  { value: 'cliente', label: 'Bike de cliente' },
];
